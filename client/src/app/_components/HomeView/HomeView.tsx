/* Home view — the body of /. Sends the user to the first repo's PR list, or
   onboarding if no repos. The redirect is client-side on purpose: data comes
   from TanStack Query (the repo's data convention — F16's server redirect was
   deliberately skipped, see docs/improvement-plan §9). */
"use client";
