/* Agent editor view — the body of /agents/:id (A2, L03). Left agent list +
   Config editor (model + system prompt). Tab state lives in ?tab= (read here
   via useSearchParams so the route page stays a thin server shell, F15).
   Ported from screen_agents.jsx. */
"use client";
