        ...
        {editing ? (
          ...
          <>
            ...
            <div style={s.confidenceRow}>
              ...
              {/* Code-counted frequency — the honest counterpart to the model's
                  self-reported score above (null when nothing identifies the rule). */}
              {candidate.occurrences != null && (
                <span>· {t("card.occurrences", { count: candidate.occurrences })}</span>
              )}
            </div>
          </>
        )}
