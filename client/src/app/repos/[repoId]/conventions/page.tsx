    ...
    <AppShell crumb={crumb}>
      <div style={s.page}>
        ...
        <div style={s.headerRow}>
          ...
          {/* Two distinct actions, not one relabelled button: the first scan
              and a re-run are different intents (the board may already hold
              triaged candidates the re-scan must preserve). */}
          {!scanned ? (
            <Button
              icon="Play"
              onClick={runScan}
