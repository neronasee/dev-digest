/* PR Detail view — the body of /repos/:repoId/pulls/:number. F2 shell
   extended by A2 with:
   ...
   Route params/searchParams are read here (useParams/useSearchParams), so the
   route page stays a thin shell. Tab state lives in query (?tab). */
"use client";
